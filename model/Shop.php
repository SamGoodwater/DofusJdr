...
class Shop extends Content
{
    ...
    //♥♥♥♥♥♥♥♥♥♥♥♥♥♥ GETTERS ♥♥♥♥♥♥♥♥♥♥♥♥♥♥
                ...
                case Content::FORMAT_EDITABLE:
                    ...
                    foreach (Shop::PRICE as $name => $value) {
                        $items[] = [
                            ...
                            "class" => "badge-outline border-".View::getColorFromLetter($value)."-d-2"
                        ];
                    }
                    return $view->dispatch(
                    ...
                    if(in_array($this->_price, Shop::PRICE)){
                        return $view->dispatch(
                            ...
                            data : [
                                ...
                                "color" => View::getColorFromLetter($this->_price)."-d-2",
        ...
        public function getConsumable(int $format = Content::FORMAT_BRUT, $is_removable = false){
            $view = new View();
        ...
        public function getItem(int $format = Content::FORMAT_BRUT, $is_removable = false){
            $view = new View();
            $manager = new ShopManager;
