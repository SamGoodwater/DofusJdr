...
class Shop extends Content
{
        ...
        public function getId_seller(int $format = Content::FORMAT_BRUT){
            ...
            switch ($format) {
                ...
                case Content::FORMAT_VIEW:
                    if(isset($npc)){
                        return $npc->getClasse(Content::FORMAT_OBJECT)->getFile("logo", new Style(['format' => Content::FORMAT_VIEW, "class" => "img-back-30"]));
                    } else {
                        return "";
                    }
    ...
    //♥♥♥♥♥♥♥♥♥♥♥♥♥♥ SETTERS ♥♥♥♥♥♥♥♥♥♥♥♥♥♥
        ...
        public function setLocation(string | int $data){
            $this->_location = $data;
            return true;
        }
        public function setPrice(string | int $data){
        ...
        public function setId_seller(string $data){
        ...
        */
        public function setConsumable(array $data){ 
            ...
            if(!isset($data['uniqid'])){ throw new Exception("L'uniqid du consommable n'est pas défini");}
                    ...
                    switch ($data['action']) {
                        ...
                        case "update":
                            if($managerS->existsLinkConsumable($this, $consumable)){
                                $link = $managerS->getLinkConsumableFromConsumable($this, $consumable);
