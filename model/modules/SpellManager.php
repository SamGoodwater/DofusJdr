...
public function add(Spell $spell){
    ...
    return $req->execute(array(
        'official_id' => $spell->getOfficial_id(),
        'dofusdb_id' => $spell->getDofusdb_id(),
        ...
        // 'effect_array' => $spell->getEffect_array(),
        ...
        'cast_per_target' => $spell->getCast_per_target(),
        ...
        "dofus_version" => $spell->getDofus_version()
    ));
}
public function update(Spell $spell){
    $req = $this->_bdd->prepare('UPDATE spell SET
                ...
                cast_per_target=:cast_per_target,
