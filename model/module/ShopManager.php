...
// Link Consumable
    ...
    public function getLinkConsumableFromConsumable(Shop $shop , Consumable $consumable){
        $req = $this->_bdd->prepare('SELECT *, link_shop_consumable.price AS price_link FROM link_shop_consumable INNER JOIN consumable ON link_shop_consumable.id_consumable = consumable.id WHERE link_shop_consumable.id_shop = ? AND link_shop_consumable.id_item = ? ORDER BY link_shop_consumable.price');
