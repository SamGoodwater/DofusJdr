...
class SpecializationFilterRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            "is_visible" => ["boolean"],
            "uniqid" => ["string", "min:1", "max:255", "required", Rule::unique("specializations", "uniqid")->ignore($this->route()->parameter('specialization'))],
