...
class PanoplyFilterRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'bonus' => ["string", "min:1", "max:255", "nullable"],
            "name" => ["string", "min:4", "max:255", "required"],
            "description" => ["string", "min:4", "max:1000", "nullable"],
            "is_visible" => ["boolean"],
            "uniqid" => ["string", "min:1", "max:255", "required", Rule::unique("panoplys", "uniqid")->ignore($this->route()->parameter('panoply'))],
