    ...
    <div>
        ...
        <aside id="default-sidebar"
            ...
            <div
                ...
                <div class="h-16 w-full flex items-center flex-no-wrap">
                    <Link :href="route('home')" preserve-scroll aria-label="Accueil">
                    <img src="/storage/app/public/logos/logo.png" alt="DofusJDR Logo" aria-label="DofusJDR Logo"
                        width="100%" height="30">
                    <span>DofusJDR</span>
                    </Link>
                </div>
                <ul class="space-y-2">
                    <li>
                        <Link :href="route('page.index')" preserve-scroll
