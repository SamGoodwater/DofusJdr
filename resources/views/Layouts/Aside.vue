...
<template>
    ...
    <div>
        <aside id="menuSidebar"
            :class="[isSidebarOpen ? 'sidebar-on' : 'sidebar-off', 'px-2', 'pt-4', 'fixed', 'top-0', 'left-0', 'bottom-0', 'z-40', 'w-64', 'transition-transform', '-translate-x-full', 'sm:translate-x-0', 'bg-base-200']"
            aria-label="Sidenav">
            ...
            <div id="footer">
                ...
                <div class="btm-nav bg-transparent border-t-2 border-base-300">
                    <button>
                        ...
                        <span class="btm-nav-label">Dark Mode</span>
                    </button>
                    <button>
