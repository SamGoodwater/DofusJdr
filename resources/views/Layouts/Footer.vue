...
<template>
    <footer class="h-14 flex justify-center">
        ...
        <div class="flex gap-6 max-sm:hidden content-center text-sm">
            <p class="">{{ appName }} - version {{ appVersion + " " + appStability }} - {{ new
                Date().getFullYear() }}</p>
            <p class="flex align-content-baseline gap-2"><svg width="18" height="18" fill="#a8b0bd"
                    viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" stroke="#a8b0bd">
                ...
                </svg><a href="mailto:contact@krosmoz-jdr.fr">contact@krosmoz-jdr.fr</a></p>
            <p class="flex align-content-baseline gap-2"><svg width="18" height="18" fill="#a8b0bd" viewBox="0 0 32 32"
                    version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#a8b0bd">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <title>discord</title>
                ...
                </svg><a href="https://discord.gg/XVu4VWFskj" target="\_blank">#XVu4VWFskj</a></p>
        </div>
        ...
        <div class="hidden max-sm:block">
            <div class="btm-nav">
                ...
                <button class="active">
                    ...
                    <span class="btm-nav-label">Accueil</span>
                </button>
                <button>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                    ...
                    <span class="btm-nav-label">Mon Compte</span>
                </button>
            </div>
        </div>
...
footer {
    ...
    background: linear-gradient(to bottom, rgba(15, 23, 42, 0), rgba(15, 23, 42, 0.5), rgba(15, 23, 42, 1));
}
</style>
