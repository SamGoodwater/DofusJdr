    ...
    if(!$currentUser->getRight('item', User::RIGHT_READ)){
      ...
      foreach ($objs as $key => $obj) {
        ...
        $json[] = array(
          ...
          'bookmark' => "<a onclick='User.toggleBookmark(this);' data-classe='item' data-uniqid='".$obj->getUniqid()."'><i class='".$bookmark_icon." fa-bookmark text-main-d-2 text-main-hover'></i></a>",
          'edit' => $edit,
