    ...
    if(!$currentUser->getRight('ressource', User::RIGHT_READ)){
      ...
      foreach ($objs as $obj) {
        ...
        $json[] = array(
          ...
          'bookmark' => "<a onclick='User.toggleBookmark(this);' data-classe='ressource' data-uniqid='".$obj->getUniqid()."'><i class='".$bookmark_icon." fa-bookmark text-main-d-2 text-main-hover'></i></a>",
