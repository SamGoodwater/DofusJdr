    ...
    if(!$currentUser->getRight('npc', User::RIGHT_READ)){
      ...
      foreach ($objs AS $obj) {
        ...
        $json[] = array(
          ...
          'bookmark' => "<a onclick='User.toggleBookmark(this);' data-classe='npc' data-uniqid='".$obj->getUniqid()."'><i class='".$bookmark_icon." fa-bookmark text-main-d-2 text-main-hover'></i></a>",
          'edit' => $edit,
