      ...
      $json = "Vous n'avez pas les droits pour lire cet objet";}else{
        ...
        foreach ($objs as $obj) {
          ...
          if($currentUser->getRight('consumable', User::RIGHT_WRITE)){
            $edit = "<a id='{$obj->getUniqid()}' class='text-main-d-2 text-main-l-3-hover' onclick=\"Consumable.open('{$obj->getUniqid()}', Controller.DISPLAY_EDITABLE)\"><i class='fa-regular fa-edit'></i></a>";
          }
          ...
          $json[] = array(
            ...
            'bookmark' => "<a onclick='User.toogleBookmark(this);' data-classe='consumable' data-uniqid='".$obj->getUniqid()."'><i class='".$bookmark_icon." fa-bookmark text-main-d-2 text-main-hover'></i></a>",
            'edit' => $edit,
