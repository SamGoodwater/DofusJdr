    ...
    <table align="left">
        ...
        <tr class="baseline center">
            ...
            <td valign="middle" class="baseline center">
                ...
                <div>
                    <div><img height="30" src="<?=$icons["time_before_use_again"]?>"></div>
                    <span class="time_before_use_again" style="top:11px;right:11px;z-index:100;"><?=$obj->getTime_before_use_again()?></span>
                </div>
            </td>
        </tr>
        <tr>
