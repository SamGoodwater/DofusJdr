...
<div class="card p-2 m-2 border-2 border-main">
    <div class="row justify-content-between align-items-center mb-1">
        ...
        <div class="col-auto">
            <?=$obj->getLevel(Content::FORMAT_BADGE)?>
        ...
        <div class="col-auto row justify-content-between">
            <div class="col-auto">
                ...
                <?php if($user->getRight('ressource', User::RIGHT_WRITE)){ ?>
                    <a class='text-main-d-2 text-main-l-3-hover' title='Modifier' onclick="Ressource.open('<?=$obj->getUniqid()?>', Controller.DISPLAY_EDITABLE);"><i class='fa-regular fa-edit'></i></a>
                <?php } ?>
            </div>                      
        </div>
    </div>
