...
<div class="card mb-3">
    ...
    <div class="row g-0">
        <div class="row justify-content-between mb-1">
            ...
            <div class="col-auto">
                ...
                <?=$obj->getPrice(Content::FORMAT_EDITABLE)?>
    ...
    <p class="text-right font-size-0-8 m-1"><a class='btn btn-sm btn-animate btn-border-red' onclick="Ressource.remove('<?=$obj->getUniqid()?>')"><i class="fa-solid fa-trash"></i> Supprimer</a></p>
</div>