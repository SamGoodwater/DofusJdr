<div class="minimal-card" style="width: 15rem;">
    <div class="minimal-card__header">
        <h5 data-prop="name" data-location="content" data-format="base" class="minimal-card__header__title"></h5>
        <div class="minimal-card__header__content">
            <img data-prop="logo" data-location="src" data-format="base" src="" class="minimal-card__header__content__img" alt="Logo du sort">
            <div class="minimal-card__body__header__content__resume">
    ...
    <div class="minimal-card__footer">
        <button class="minimal-card__footer__btn">Plus d'informations</button>
        <div class="minimal-card__footer__content"> 
