...
// Conseillé
    ...
    $onclick = "";
    if($is_link){
        $onclick = "ondblclick=\"Consumable.open('".$obj->getUniqid()."');\"";
    }    
?>

<p data-event-trigger="mouseover" data-event-type="tooltips" data-event-target="#consumable<?=$obj->getUniqid()?>" onmouseover="showTooltips(this);" <?=$onclick?>>
