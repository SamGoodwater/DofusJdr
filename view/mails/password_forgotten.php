<?php
    $is_error = false;
    $error_msg = "";
    if(!isset($password)) {$is_error = true; $error_msg = "Le mot de passe envoyé n'est pas valide";}else{if(!is_string($password)) {$is_error = true; $error = "Le mot de passe envoyé n'est pas valide";}}
?>
