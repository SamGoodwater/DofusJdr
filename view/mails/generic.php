<?php
    $is_error = false;
    $error_msg = "";
    if(!isset($text)) {$is_error = true; $error_msg = "Le contenu envoyé n'est pas valide";}else{if(!is_string($text)) {$is_error = true; $error = "Le contenu envoyé n'est pas valide";}}
?>
